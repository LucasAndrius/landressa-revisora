...
export const metadata: Metadata = {
  title: "Landressa Schiefelbein | Portfólio",
  description: "Generated by create next app",
};

export default async function Portfolio() {
  const projects = await getProjectLatests();
  const lastReviewedName = await getLastReviewedBookName();
  ...
  return (
    <div>
      ...
      <Container>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-[55%_45%] lg:grid-cols-[65%_35%] md:mx-32 lg:mx-0 my-[40px]">
          ...
          <div className="hidden sm:block my-10 sm:my-0 lg:mx-10 ">
            <div>
